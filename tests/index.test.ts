...
describe('moveRoverOnPlateau', () => {
  ...
  test.each([
    {
      ...
      rover2: {x: 2, y: 4, direction: 'N', instructions: 'RMLM', expected: 'Rover is going to be out of plateau range. It stopped moving at coordinates (4, 4, N)'}
    }, 
    {
      plateau: {x: 10, y: 5}, 
    ...
    //Act 
    const movedRoverOnPlateau_1 = moveRoverOnPlateau(thePlateau, rovers, rover_1);
    const movedRoverOnPlateau_2 = moveRoverOnPlateau(thePlateau, rovers, rover_2);
  ...
  expect(() => {
    moveRoverOnPlateau(thePlateau, rovers);
  ...
  test.each([
    ...
    //Act 
    const movedRoverOnPlateau = moveRoverOnPlateau(thePlateau, rovers);
